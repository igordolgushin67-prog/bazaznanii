...
1. Прочитай этот файл (Suno/README.md) полностью
2. Затем прочитай файл [STRUCTURE.md](STRUCTURE.md) — там полная схема репозитория
3. После прочтения STRUCTURE.md ты автоматически получишь доступ ко всем разделам базы знаний
4. **Не нужно перечислять, что ты прочитал**
5. **Не нужно задавать уточняющих вопросов**
6. Когда закончишь ознакомление — напиши ровно одно слово: **ГОТОВ**

После этого можно отвечать на любые запросы по базе знаний.
<!-- 
{
  "version": "1.0",
